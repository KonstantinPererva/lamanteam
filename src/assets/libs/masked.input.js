!function (e) {
    ...
    var a, e = navigator.userAgent, A = /iphone/i.test(e), i = /chrome/i.test(e), T = /android/i.test(e);
    S.mask = {
        ...
        caret: function (e, t) {
            ...
            return v = S.extend({
                ...
                function o() {
                    if (v.completed) {
                        for (var e = y; e <= x; e++) if (b[e] && m[e] === c(e)) return;
                        v.completed.call(g)
                    }
                }
                ...
                function h(e) {
                    var t, n, a, i = g.val(), r = -1;
                    for (a = t = 0; t < j; t++) if (b[t]) {
                        for (m[t] = c(t); a++ < i.length;) if (n = i.charAt(a - 1), b[t].test(n)) {
                            m[t] = n, r = t;
                            break
                        }
                        if (a > i.length) {
                ...
                var g = S(this), m = S.map(t.split(""), function (e, t) {
                ...
                g.data(S.mask.dataName, function () {
                    ...
                    if (!g.prop("readonly")) {
                        var t, n, a, i = e.which || e.keyCode, r = g.caret();
                        e.ctrlKey || e.altKey || e.metaKey || i < 32 || !i || 13 === i || (r.end - r.begin != 0 && (f(r.begin, r.end), u(r.begin, r.end - 1)), (t = l(r.begin - 1)) < j && (n = String.fromCharCode(i), b[t].test(n)) && (function (e) {
                            var t, n, a, i;
                            for (n = c(t = e); t < j; t++) if (b[t]) {
